      ...
      <Layout>
        ...
        <div id="main">
          ...
          <section id="content" className="main">
            ...
            <h2>Results</h2>
            <p>A mobile first approach using adaptive content was implemented which saw a 28% decrease in page weight on mobile and a 58% decrease on desktop, along with increases in performance, accessiblity, SEO rankings, and a 93% decrease in usablitiy errors. The new pages also saw a 300% increase in mobile bookings in their first 2 months of being live and continue to be some of the highest performing landing pages on Southwest.com.</p>
