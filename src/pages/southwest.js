      ...
      <Layout>
        ...
        <div id="main">
          <section id="content" className="main">
            ...
            <span className="image main"><img src={southwest_desktop} alt="" width="800" height="auto" /></span>
            <span className="image secondary"><img src={southwest_wireframe} alt="" width="800" height="auto" /></span>
            {/*<span className="image secondary"><img src={southwest_mobile} alt="" width="800" height="auto" /></span>*/}
